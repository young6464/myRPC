...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::User::LoginRequest, pwd_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::User::RegisterRequest, pwd_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_2eproto = {
  false, false, descriptor_table_protodef_user_2eproto, "user.proto", 445,
...
// @@protoc_insertion_point(class_specific_merge_from_start:User.LoginResponse)
  ...
  if (from.has_result()) {
    _internal_mutable_result()->::User::ResultCode::MergeFrom(from._internal_result());
  }
  if (from.success() != 0) {
